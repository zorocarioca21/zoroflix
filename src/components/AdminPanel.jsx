                ...
                {activeTab === 'settings' && (
                    <div className="admin-settings-section">
                        ...
                        <div className="settings-grid-admin">
                            ...
                            <div className="settings-row-card">
                                <div className="setting-info"><h3>Nosso Player p/ Todos</h3><p>Força usar Telegram Player se baixado (Free/Guests).</p></div>
                                <button className={`btn-toggle-ads ${configs.force_custom_player_all ? 'active' : ''}`} onClick={() => updateConfig('force_custom_player_all')}>{configs.force_custom_player_all ? 'ON' : 'OFF'}</button>
                            </div>
                            <div className="settings-row-card warning">
